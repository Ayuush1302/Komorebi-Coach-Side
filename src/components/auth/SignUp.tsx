...
export default function SignUp() {
  ...
  const handleVerification = (e: React.FormEvent) => {
    ...
    // Predefined verification code for prototype
    if (verificationCode === '123456') {
      // Create username from email (before @ symbol)
      const username = email.split('@')[0];
      updateUser({ username, email, onboardingComplete: false, role });

      if (role === 'coach') {
        navigate('/onboarding/basic-info');
      } else {
        navigate('/onboarding/athlete/profile');
      }
    } else {
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <h2 className="text-2xl mb-2 text-center">Verify your email</h2>
            <p className="text-gray-600 text-center mb-2 text-sm">
              We've sent a verification code to {email}
            </p>

            {/* Prototype helper message */}
            <div className="bg-blue-50 border border-blue-200 rounded-md p-3 mb-6">
              <p className="text-xs text-blue-800 text-center">
                <strong>Prototype:</strong> Use code <strong>123456</strong>
              </p>
            </div>
            ...
            <form onSubmit={handleVerification} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-center text-lg tracking-widest"
                  placeholder="000000"
                  maxLength={6}
                  required
                />
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          <h1 className="text-4xl mb-2">Komorebi</h1>
          <p className="text-gray-600">Create your ecosystem account</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={role === 'coach' ? "coach@example.com" : "athlete@example.com"}
                  required
                />
              </div>
            </div>

...
import { ArrowLeft, Bell, Lock, CreditCard, Globe } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              ...
              >
                <div
                  className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${emailNotifications ? 'translate-x-6' : 'translate-x-0.5'
                    }`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors ${pushNotifications ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
              >
                <div
                  className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${pushNotifications ? 'translate-x-6' : 'translate-x-0.5'
                    }`}
                />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between py-3">
              ...
              <button
                ...
                className={`relative w-12 h-6 rounded-full transition-colors ${athleteUpdates ? 'bg-blue-600' : 'bg-gray-300'
                  }`}
              >
                <div
                  className={`absolute top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${athleteUpdates ? 'translate-x-6' : 'translate-x-0.5'
                    }`}
                />
              </button>
            </div>

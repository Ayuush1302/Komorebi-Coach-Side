...
import AthleteActivity from './components/athlete/AthleteActivity';
import AthleteCreatePost from './components/athlete/AthleteCreatePost';

// Existing Components (reused)
import Athletes from './components/athletes/Athletes';
import AthleteDashboard from './components/athletes/AthleteDashboard';
import AIWorkoutAssistant from './components/athletes/AIWorkoutAssistant';
              ...
              <FeedProvider>
                <Routes>
                  ...
                  <Route element={<PrivateRoute><AthleteAppLayout><Outlet /></AthleteAppLayout></PrivateRoute>}>
                    ...
                    <Route path="/athlete/create-post" element={<AthleteCreatePost />} />
